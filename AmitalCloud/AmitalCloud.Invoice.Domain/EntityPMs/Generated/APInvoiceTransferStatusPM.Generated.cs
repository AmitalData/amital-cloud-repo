...
namespace AmitalCloud.Invoice.Domain.EntityPMs
{
   ...
   [DataContract]
   public partial class APInvoiceTransferStatusPM : BaseEntityPM   {
   #region Constructors
   public APInvoiceTransferStatusPM() : base() {} 
   public APInvoiceTransferStatusPM(POCO.APInvoiceTransferStatus entity) : base()
   {
		_code = entity.Code;
		_name = entity.Name;
