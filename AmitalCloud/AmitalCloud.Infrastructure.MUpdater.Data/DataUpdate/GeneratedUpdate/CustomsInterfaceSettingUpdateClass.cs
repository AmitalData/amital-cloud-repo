...
namespace AmitalCloud.Infrastructure.MUpdater.Data.DataUpdate.GeneratedUpdate
{
   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTablePM()
            {
	             				    ...
	             				    ObjectTableName =  "CustomsInterfaceSetting",
			      				    ...
			      				    HashString =  CustomsInterfaceSettingUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,Repository<ObjectField> ObjectFieldsRepository,Repository<TextCode> TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "ActivateCustomsManagementInShipments",
					  						ShortName =  "ActivateCustManagInShipments",
					  						ObjectTableName =  "CustomsInterfaceSetting",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "LocalCustomsInterfaceCode",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "CustomsInterface",
					  						NavigationPropertyName =  "LocalCustomsInterface",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "ImportToUSAInterfaceCode",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "CustomsInterface",
					  						NavigationPropertyName =  "ImportToUSAInterface",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "ExportFromUSAInterfaceCode",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "CustomsInterface",
					  						NavigationPropertyName =  "ExportFromUSAInterface",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "ArtemusOutSettingsId",
					  						...
					  						NavigationPropertyName =  "ArtemusOutSettings",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "ArtemusInSettingsId",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "FTPDetail",
					  						NavigationPropertyName =  "ArtemusInSettings",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "LocalCustomsInterfaceName",
					  						ObjectTableName =  "CustomsInterfaceSetting",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  40,
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "LocalCustomsInterfaceName",
					  						ListPropertyPath =  "LocalCustomsInterfaceName",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
	    ...
	    {  
		   ...
		   Feature CustomsInterfaceSettingFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeaturePM() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = false, ObjectTableId = CustomsInterfaceSettingObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomsInterfaceSetting.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,CustomsInterfaceSettingObjectTable,contextTenant);
		   Feature CustomsInterfaceSettingFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeaturePM() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = false, ObjectTableId = CustomsInterfaceSettingObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomsInterfaceSetting.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,CustomsInterfaceSettingObjectTable,contextTenant);
		   Feature CustomsInterfaceSettingFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeaturePM() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = false, ObjectTableId = CustomsInterfaceSettingObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomsInterfaceSetting.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,CustomsInterfaceSettingObjectTable,contextTenant);
		   Feature CustomsInterfaceSettingFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeaturePM() { Code = "Module", FeatureTypeCode = "MODL", IsBusinessUnitEnabled = false, ObjectTableId = CustomsInterfaceSettingObjectTable.Id, Tenant = 0, NameTextCodeCode = "CustomsInterfaceSetting.Features.PackageFeature", NameTextCodeDefaultText = "CustomsInterfaceSetting Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,CustomsInterfaceSettingObjectTable,contextTenant);    
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypePM()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = CustomsInterfaceSettingObjectTable.Id,
