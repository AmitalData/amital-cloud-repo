...
{
   public class ComputingPartnerTranslationUpdateClass
   {  		
		public const string HashString = "429794482b7fa0c38623744714062889";
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTablePM()
            {
	             				    ...
	             				    ObjectTableName =  "ComputingPartnerTranslation",
			      				    ...
			      				    OldDBTableName =  "ComputingPartnerTranslations",
			      				    ...
			      				    Code =  "bc81",
			      				    Name =  "ComputingPartnerTranslation",
			      				    ...
			      				    HasDocuments =  false,
			      				    IsLookUp =  false,
			      				    SearchFields =  "ComputingPartnerTranslation,ComputingPartnerTranslations,,Id,",
			      				    HashString =  ComputingPartnerTranslationUpdateClass.HashString,
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,Repository<ObjectField> ObjectFieldsRepository,Repository<TextCode> TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "Id",
					  						...
					  						ValidForQuerySection1 =  "ComputingPartnerTranslation",
					  						IsRestrictable =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "OurCode",
					  						...
					  						IsTimeFrameFilter =  false,
					  						DisplayInSearchWindowList =  false,
					  						PMPropertyPath =  "OurCode",
					  						ListPropertyPath =  "OurCode",
					  						DisplayInLookUpIndex =  0,
					  						AutomaticField =  false,
					  						UniqueField =  false,
					  						DisplayInSearchWindowListIndex =  0,
					  						...
					  						InActive =  false,
					  						DisplayLongName =  false,
					  						FullFieldLable =  "OurCode",
					  						DefaultText =  "Our Code",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "ComputingPartnerId",
					  						OldFieldName =  "ComputingPartnerId",
					  						ObjectTableName =  "ComputingPartnerTranslation",
					  						FieldsDataType =  "LookUp",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "ComputingPartnerName",
					  						OldFieldName =  "ComputingPartnerName",
					  						ObjectTableName =  "ComputingPartnerTranslation",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  0,
	    ...
	    {  
		   ObjectTable ComputingPartnerTranslationObjectTable = ObjectContext.ObjectTables.Where(d => d.Name == "ComputingPartnerTranslation" && d.Tenant == 0).FirstOrDefault(); 
	    ...
	    {   
            ...
            AddEventTypes.AddEventType(new EventTypePM()
            {
                ...
                IsFollowUp =  false,
                ObjectTableId = ComputingPartnerTranslationObjectTable.Id,
