...
namespace AmitalCloud.Infrastructure.MUpdater.Data.DataUpdate.GeneratedUpdate
{
   ...
   {  		
        ...
        {                     
            ...
            AddObjectsAndObjectFields.AddObjectTable(new ObjectTablePM()
            {
	             				    ...
	             				    ObjectTableName =  "Card",
			      				    ...
			      				    LocalDefaultTextBack_up =  "כרטיסים",
			      				    LocalDefaultText =  "BS64:Iteb16jXmNeZ16HXmdedIg==",
			      				    DefaultText =  "Card",
			      				    Code =  "1561",
			      				    Name =  "Card",
	    ...
	    public void AddObjectFields(Dictionary<string, ObjectField> objectFields, Dictionary<string, ObjectTable> objectTables, Dictionary<string, TextCode> textCodes,Repository<ObjectField> ObjectFieldsRepository,Repository<TextCode> TextCodeRepository, List<ObjectField> addedFields, List<TextCode> addedTextCodes,int contextTenant)
	    {
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "SharedLogisticsInvitationStatusCode",
					  						ShortName =  "SharedLogInvitationStatCode",
					  						ObjectTableName =  "Card",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  4,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "CargoTrackingInvitationStatusCode",
					  						ShortName =  "CargoTracInvitationStatCode",
					  						ObjectTableName =  "Card",
					  						FieldsDataType =  "Text",
					  						MinLength =  0,
					  						MaxLength =  4,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "SearchFields",
					  						...
					  						FullLocalDefaultTextBack_up =  "חפש שמות/ח.פ./מדינה",
					  						FullLocalDefaultText =  "BS64:IteX16TXqSDXqdee15XXqi/Xly7XpC4v157Xk9eZ16DXlCI=",
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "LocalName",
					  						...
					  						ShortLocalDefaultTextBack_up =  "שם בעברית",
					  						ShortLocalDefaultText =  "BS64:Itep150g15HXoteR16jXmdeqIg==",
					  						IsForeignKey =  false,
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "SingleInvoiceTemplateId",
					  						...
					  						NavigationPropertyName =  "SingleInvoiceTemplate",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "CustomsInvoiceTemplateId",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "DocumentTypeTemplate",
					  						NavigationPropertyName =  "CustomsInvoiceTemplate",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "ConsolidationInvoiceTemplateId",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "DocumentTypeTemplate",
					  						NavigationPropertyName =  "ConsolidationInvoiceTemplate",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
			   ...
			   AddObjectsAndObjectFields.AddObjectField(new ObjectFieldPM() 
			   {
					 						...
					 						FieldName =  "ManifestInvoiceTemplateId",
					  						...
					  						IsForeignKey =  true,
					  						ForeignEntity =  "DocumentTypeTemplate",
					  						NavigationPropertyName =  "ManifestInvoiceTemplate",
					  						IsMaxLength =  false,
					  						NoMetaDataField =  false,
					  						IsFixedLength =  false,
					  						EnableAutoFill =  false,
	    ...
	    {  
	        ...
	        QueryGroup CardQueryGroup = AddQueryGroups.AddQueryGroup(new QueryGroupPM() { Code = "1561", Name = "Card" }, queryGroupRepository,tenantQueryGroups);
						QueryGroup CardQueryGroup1 = AddQueryGroups.AddQueryGroup(new QueryGroupPM() { Code = "573b", Name = " Query Group" }, queryGroupRepository,tenantQueryGroups);
			...
			List<AdvancedQueryFilter> addedQueryFilters = new List<AdvancedQueryFilter>();
			   ...
			   TextCode CardTextCode_0 = AddTextCodes.AddTextCode(new TextCodePM() { Code = "Card.Q.CToolPartners", DefaultText = @"CTool Partners",LocalDefaultText = null, ObjectTableId = CardObjectTable.Id, Tenant = 0, TextCodeTypeCode = "Q", }, textCodes, addedTextCodes,contextTenant);
			   Feature CardFeature_0 = AddRolesAndFeaturesClass.AddFeature(new FeaturePM() { Code = "Card.Q.CToolPartners", ObjectTableId = CardObjectTable.Id, Tenant = 0, NameTextCodeCode = "CardFeatures.CToolPartners", NameTextCodeDefaultText = "CTool Partners", FeatureTypeCode = "QUER", Packagable = true }, TenantFeatures, textCodes,CardObjectTable, addedFeatures, addedTextCodes,contextTenant);

	        
																		    
	      

			  Query CToolPartnersQuery = AddQueries.AddQuery(new QueryPM() { NameTextCodeId = CardTextCode_0.Id, NameTextCodeCode = CardTextCode_0.Code, ObjectTableName = "Card", Code = "CTool Partners",  EditWizardName = "SharedLogistics.Views.InviteCustomersControl",
			   QueryGroupCode = "1561", IndexOrder = 0, Tenant = 0, ObjectTableId = CardObjectTable.Id, QuerySection = "Card", SystemLevel = true, IsAddNewEntityEnabled = false, FeatureId = CardFeature_0.Id,FeatureUniqeCode= CardFeature_0.FeatureUniqeCode, DefaultSortColumn = "SharedLogisticsInvitationStatusName", DefaultSortDirection = "Desending", Perspective = "Cards" }, addedQueries,contextTenant);
	
			 QueryColumn CToolPartnersQueryColumn_0 = AddQueries.AddQueryColumn(new QueryColumnPM { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 0, ObjectFieldCode = "Card.SharedLogisticsInvitationStatusName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CToolPartnersQueryColumn_1 = AddQueries.AddQueryColumn(new QueryColumnPM { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 1, ObjectFieldCode = "Card.Code" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CToolPartnersQueryColumn_2 = AddQueries.AddQueryColumn(new QueryColumnPM { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 2, ObjectFieldCode = "Card.EnglishName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CToolPartnersQueryColumn_3 = AddQueries.AddQueryColumn(new QueryColumnPM { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 3, ObjectFieldCode = "Card.LocalName" , ColumnWidth = 100 }, addedQueryColumns,contextTenant);

			 QueryColumn CToolPartnersQueryColumn_4 = AddQueries.AddQueryColumn(new QueryColumnPM { Tenant = 0, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, IndexOrder = 4, ObjectFieldCode = "Card.PartnerTypeName" , ColumnWidth = 200 }, addedQueryColumns,contextTenant);

             AdvancedQueryFilter CToolPartnersQueryFilter_0 = AddQueries.AddAdvancedQueryFilter(new AdvancedQueryFilterPM() { IsPredefined = true, ObjectFieldCode = "Card.PartnerTypeId", PredefinedValue = "CS",PredefinedValue2 = null, CustomPredefined = false, QueryId = CToolPartnersQuery.Id,QueryCode = CToolPartnersQuery.UniqueCode, Tenant = 0,Operator = "NotEqual"}, addedQueryFilters,contextTenant);
	    ...
	    {   
		   ...
		   //List<ObjectField> CardObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "Card").ToList();
	         ...
	         Screen CardCardHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenPM() { Code = "Card.HeaderScreen", Name = "CardHeaderScreen", ObjectTableId = CardObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
	    ...
	    {  
		   ...
		   Feature CardFeatureNew = AddRolesAndFeaturesClass.AddFeature(new FeaturePM() { Code = "NEW", FeatureTypeCode = "NEW", IsBusinessUnitEnabled = false, ObjectTableId = CardObjectTable.Id, Tenant = 0, NameTextCodeCode = "Card.Features.New", NameTextCodeDefaultText = "New" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,CardObjectTable,contextTenant);
		   Feature CardFeatureRead = AddRolesAndFeaturesClass.AddFeature(new FeaturePM() { Code = "READ", FeatureTypeCode = "READ", IsBusinessUnitEnabled = false, ObjectTableId = CardObjectTable.Id, Tenant = 0, NameTextCodeCode = "Card.Features.Read", NameTextCodeDefaultText = "Read" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,CardObjectTable,contextTenant);
		   Feature CardFeatureUpdate = AddRolesAndFeaturesClass.AddFeature(new FeaturePM() { Code = "UPDATE", FeatureTypeCode = "UPDT", IsBusinessUnitEnabled = false, ObjectTableId = CardObjectTable.Id, Tenant = 0, NameTextCodeCode = "Card.Features.Edit", NameTextCodeDefaultText = "Edit" }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,CardObjectTable,contextTenant);
		   Feature CardFeatureModule = AddRolesAndFeaturesClass.AddFeature(new FeaturePM() { Code = "Module", FeatureTypeCode = "MODL", IsBusinessUnitEnabled = false, ObjectTableId = CardObjectTable.Id, Tenant = 0, NameTextCodeCode = "Card.Features.PackageFeature", NameTextCodeDefaultText = "Card Package Feature", Packagable = true }, FeaturesRepository, TextCodeRepository, TenantFeatures, TextCodes,CardObjectTable,contextTenant);    
