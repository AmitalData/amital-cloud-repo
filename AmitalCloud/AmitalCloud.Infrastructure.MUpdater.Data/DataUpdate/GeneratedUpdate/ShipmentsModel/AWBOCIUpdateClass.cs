...
namespace AmitalCloud.Infrastructure.MUpdater.Data.DataUpdate.GeneratedUpdate.ShipmentsModel
{
   ...
   {  		
		public const string HashString = "0c7a67819f505c92596969e935d502ef";
	    ...
	    {   
		   ...
		   //List<ObjectField> AWBOCIObjectFields = ObjectContext.ObjectFields.Where(d => d.ObjectTable.Name == "AWBOCI").ToList();
	         ...
	         Screen AWBOCIAWBOCIHeaderScreenScreen0 = AddScreensAndScreenFields.AddScreen(new ScreenPM() { Code = "AWBOCI.HeaderScreen", Name = "AWBOCIHeaderScreen", ObjectTableId = AWBOCIObjectTable.Id, NumberOfColumns = 2, NumberOfRows = 1, IsReadOnly = true }, screensRepository, tenantScreens,contextTenant);
