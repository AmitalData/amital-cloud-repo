...
namespace AmitalCloud.Infrastructure.Application
{
   public class ToggleDetails : Toggle, ICloseTable<Toggle, ToggleDetails>
   {
       public List<ToggleDetails> GetAll()
       {
            ...
            {    
                Code = "CPH", 
                Name = "Consequent Pickup_Delivery", 
            ...
            {    
                Code = "OPD", 
                Name = "Standalone Pickups_Deliveries Only ", 
            ...
            {    
                Code = "VIP", 
                Name = "Container Tracking_Pilot Customer", 
            ...
            {    
                ...
                Name = " AP Invoice Payment Status based on Reconciliation", 
			});
