...
namespace AmitalCloud.Infrastructure.Application
{
   public class RegimenFiscalDetails : RegimenFiscal, ICloseTable<RegimenFiscal, RegimenFiscalDetails>
   {
       public List<RegimenFiscalDetails> GetAll()
       {
            ...
            {    
                Code = "607", 
                Name = "Regimen de Enajenación o Adquisición de Bienes", 
            ...
            {    
                Code = "611", 
                Name = "Ingresos por Dividendos_socios y accionistas", 
            ...
            all.Add(new RegimenFiscalDetails()
            {    
                Name = "Regimen de las Actividades Empresariales con ingresos a través de Plataformas Tecnológicas", 
                Code = "625", 
            ...
            all.Add(new RegimenFiscalDetails()
            {    
                Name = "Regimen Simplificado de Confianza", 
                Code = "626", 
